...
public class SimpleQueueServiceSample {
	...
	public static void initQueue() throws Exception {
        ...
        try {            
          ...
          System.out.println();
        	...
        	CreateQueueRequest createQueueRequest = new CreateQueueRequest("NewTweets");
	...
	public static void sendNewTweets(ArrayList<TweetModel> NewTweets){
		Gson gson=new Gson();
        JsonElement element= gson.toJsonTree(NewTweets, new TypeToken<ArrayList<TweetModel>>() {}.getType());
        JsonArray jsonArray = element.getAsJsonArray();        
        sqs.sendMessage(new SendMessageRequest(myQueueUrl, jsonArray.getAsString()));
	}
}
